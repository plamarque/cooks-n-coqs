...
/** SHA-256 hex (UTF-8) sans `crypto.subtle`. */
function sha256HexUtf8SyncJs(text) {
...
/**
 * @param {import("./recipe").ImportSource | undefined} source
 * @returns {Promise<string | undefined>}
 */
export async function computeImportSourceStableKey(source) {
...
/**
 * @param {Pick<import("./recipe").Recipe, "source" | "importSourceStableKey">} recipe
 * @returns {Promise<string | undefined>}
 */
export async function resolveImportSourceStableKey(recipe) {
